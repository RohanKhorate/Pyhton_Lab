# Que 1  Suppose you are a teacher, and you want to analyze the exam scores of your students in a particular subject. 
...
scores_series = pd.Series(exam_scores, index=student)
